...
if len(results) > 0:
    ...
    for i in results.flatten():
        ...
        crop = image_BGR[x_min:x_min + box_width, y_min:y_min + box_height]  
        crop2 = image_BGR[y_min:y_min + box_width, x_min:x_min + box_height]  
        crop3 = image_BGR[y_min:y_min + box_height, x_min:x_min + box_width]  
